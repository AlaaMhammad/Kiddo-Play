{{-- <!doctype html>
<html lang="en" class="layout-wide customizer-hide" dir="ltr" data-skin="default" data-assets-path="{{ asset('dashboard/assets/') }}" data-template="vertical-menu-template">
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form id="parentChildForm" method="POST" action="">
                            @csrf
                            <!-- Parent Info -->
                            <h6>Parent Info</h6>
                            ...
                            <div class="mb-3 form-password-toggle form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="parentPassword" name="parentPassword" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" required>
                            ...
                            <div class="mb-3 form-control-validation">
                                ...
                                <input type="date" id="childDob" name="childDob" class="form-control" required>
                            </div>
                            <div class="mb-3 form-control-validation">
                                <label for="childGender" class="form-label">Gender</label>
                                <select id="childGender" name="childGender" class="form-select" required>
                            ...
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary d-grid w-100"><i class='bx bx-check-circle'></i> Register</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form id="parentChildForm" method="POST" action="{{ route('signup') }}">
                            ...
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary d-grid w-100"><i
                                        class='bx bx-check-circle'></i> Register</button>
                            </div>
            ...
            <hr class="text-success">
                <div class="child-entry mb-3">
                    <div class="mb-2 form-control-validation">
                        ...
                        <input type="text" id="childName${childCount}" name="children[${childCount-1}][name]" class="form-control" required>
                    </div>
                    <div class="mb-2 form-control-validation">
                        <label for="childDob${childCount}" class="form-label">Date of Birth</label>
                        <input type="date" id="childDob${childCount}" name="children[${childCount-1}][dob]" class="form-control" required>
                    </div>
                    <div class="mb-2 form-control-validation">
                        <label for="childGender${childCount}" class="form-label">Gender</label>
                        <select id="childGender${childCount}" name="children[${childCount-1}][gender]" class="form-select" required>
                            <option value="">Select</option>
                            <option value="male">Male</option>
                            <option value="female">Female</option>
                            <option value="other">Other</option>
