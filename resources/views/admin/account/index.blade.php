        ...
        <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <div hidden><img src="{{ auth()->user()->image }}" alt="image" class="d-block rounded"
                                    height="100" width="100" id="old-image" />
                            </div>
                            <img src="{{ auth()->user()->image }}" alt="image" class="d-block rounded" height="100"
                                width="100" id="uploaded-image" />
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="formChangePassword" method="POST" action="{{ route('admin.account.change_password') }}">
                        @csrf
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="old_password" class="form-label">{{ __('Current Password') }}</label>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#btnChangePassword').on('click', function() {
                    ...
                    $.ajax({
                        url: "{{ url('admin/account/password/change') }}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        type: 'POST',
